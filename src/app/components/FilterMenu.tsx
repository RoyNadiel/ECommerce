...
export default function FilterMwnu(props: Props) {
  ...
  return (
    <section>
      {/* Menu */}
      <div
        className="sticky top-20 w-full grid grid-cols-1 gap-x-10 gap-y-3 p-3 z-10 
      ...
      >
        ...
        <div className="h-fit flex flex-row sm:flex-row items-center gap-2 justify-between col-span-full">
          <div className="w-full flex items-center gap-2">
            <h2
              className="w-full inline-flex items-center gap-x-1 text-md md:text-2xl font-semibold text-gray-900 dark:text-white"
              onClick={() => {
          ...
          {(category !== "TodasLasCategorias" ||
            ...
            <button
              ...
              className="text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600 hover:cursor-pointer dark:hover:text-blue-400 transition-colors duration-200 font-medium
        ...
        {isOpen && (
          <>
            <div className="w-full lg:col-start-1 mt-2">
              <label
                htmlFor="Buscar producto"
                className="block text-sm md:text-md font-medium text-gray-700 dark:text-gray-300 mb-2"
              >
                Buscar producto
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  autoFocus
                  className="w-full border text-sm md:text-md border-blue-500 rounded-md py-2 pl-10 pr-4"
                  value={query}
            ...
            <div className="w-full sm:col-start-2 lg:col-start-2">
              ...
              <div className="relative">
                ...
                <select
                  name="Categorias"
                  className="w-full border text-sm md:text-md border-purple-300 dark:bg-gray-900 rounded-md py-2 pl-10 pr-6"
                  value={category}
                  onChange={(e) => setCategory(e.target.value)}
                >
                  <option
                    className="text-sm md:text-md dark:bg-gray-900"
            ...
            <div className="w-full sm:col-start-1 lg:col-start-3">
              ...
              <div className="relative">
                ...
                <select
                  name="Stock"
                  className="w-full text-sm md:text-md border border-red-300 dark:bg-gray-900 rounded-md py-2 pl-10 pr-4"
                  value={stock}
            ...
            <div className="w-full sm:col-start-2  lg:col-start-4">
              ...
              <div className="relative">
                ...
                <select
                  name="Menor o Mayor"
                  className="w-full border text-sm md:text-md border-green-300 dark:bg-gray-900 rounded-md py-2 pl-10 pr-4"
                  value={priceOrder}
            ...
            <label className="absolute text-sm md:text-md top-full right-2 mt-2 dark:text-gray-300 text-gray-500">
