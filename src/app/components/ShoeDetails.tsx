...
// }
// export default function ShoeProduct({ brand, size, price, color, image_url, onDeselectProductAction }: ShoeCardProps) {
...
//                     <SwiperSlide><Image src="/products/EYE.png" alt="Rinnegan" width={500} height={550} className='aspect-square object-contain' ></Image></SwiperSlide>
//                 </Swiper>
//             </div>
...
//                 '>
//                     <div className=''>
//                         <p className='text-gray-700 text-sm flex justify-between items-center'>Nuevo <button onClick={onDeselectProductAction}
//                             className='w-8 h-5 flex cursor-pointer justify-center items-center hover:bg-blue-400 hover:text-black'>X</button></p>
...
//                         <p className='text-lg text-green-800'>{(price).toFixed(2)} Bs.</p>
